...
return loadstring(downloadFile('vape/guis/new.lua'), 'gui')()
local mainapi = {
	Categories = {},
	GUIColor = {
		Hue = 0.46,
...
local getcustomassets = {
	['vape/assets/rise/slice.png'] = 'rbxasset://risesix/slice.png',
	['vape/assets/rise/blur.png'] = 'rbxasset://risesix/blur.png',
...
local function writeFont()
	...
	writefile('vape/assets/rise/risefont.json', httpService:JSONEncode({
		name = 'ProductSans',
		faces = {
			{style = 'normal', assetId = getcustomasset('vape/assets/rise/SF-Pro-Rounded-Light.otf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('vape/assets/rise/SF-Pro-Rounded-Regular.otf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('vape/assets/rise/SF-Pro-Rounded-Medium.otf'), name = 'Medium', weight = 500},
			{style = 'normal', assetId = getcustomasset('vape/assets/rise/Icon-1.ttf'), name = 'Icon1', weight = 600},
			{style = 'normal', assetId = getcustomasset('vape/assets/rise/Icon-3.ttf'), name = 'Icon3', weight = 800}
		}
	}))
	return getcustomasset('vape/assets/rise/risefont.json')
end
...
do
	...
	local res = isfile('vape/profiles/gui.txt') and loadJson('vape/profiles/gui.txt')
	if res then
		...
		for i, v in mainapi.Modules do
			if v.Enabled or table.find(found, i) then
				...
				if interfacebar.Enabled then
					...
					holderline.Image = getcustomasset('vape/assets/rise/slice.png')
